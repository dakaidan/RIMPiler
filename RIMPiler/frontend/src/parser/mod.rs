...
use super::AST::{
    ArithmeticExpression, ArithmeticOperator, Block, BooleanExpression,
    BooleanOperator, Program, RelationOperator, Statement, UnaryArithmeticOperator,
    UnaryBooleanOperator, Variable
};
...
impl Parser {
    ...
    fn map_type(&mut self, identifier: String, type_: String) -> Result<()>
    {
    ...
    fn get_type(&self, identifier: &String) -> Result<String>
    {
    ...
    pub fn parse_program(&mut self, tokens: &mut Tokens) -> Result<Program> {
    ...
    fn parse_relations(&mut self, tokens: &mut Tokens) -> Result<BooleanExpression> {
